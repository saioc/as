...
if($row1['username']==$username)
{
	...
	if($username) {
		$dsql->ExecuteNoneQuery("INSERT INTO `sea_member`(id,username,password,email,regtime,regip,state,gid,points,logincount,stime)
                  VALUES ('','$username','$pwd','$email','$dtime','$ip','1','2','0','1','1533686888')");
