...
$menu=array (
	...
	'tool'=>array (
		...
		13=>"<a target='I2' href='ebak/ChangeDb.php'>数据库备份</a>",
		14=>"<a target='I2' href='ebak/ReData.php'>数据库还原</a>",
		15=>"<a target='I2' href='ebak/ChangePath.php'>备份文件管理</a>",
		16=>"<a target='I2' href='ebak/ChangeDb.php'>数据库修复优化</a>",
	),
	'gathersoft'=>array (
		...
		4=>"",
		5=>"<a target='I2' href='admin_collect.php?action=main'>视频项目列表</a>",
		6=>"<a target='I2' href='admin_collect.php?action=add'>添加视频项目</a>",
		7=>"<a target='I2' href='admin_collect.php?action=customercls'>视频分类转换</a>",
		8=>"<a target='I2' href='admin_collect.php?action=filters'>视频信息过滤</a>",
		9=>"<a target='I2' href='admin_collect.php?action=tempdatabase'>视频采集数据库</a>",
		10=>"<a target='I2' href='admin_collect.php?action=importrule'>导入采集规则</a>",
		11=>"",
		12=>"<a target='I2' href='admin_collect_news.php?action=main'>新闻项目列表</a>",
		13=>"<a target='I2' href='admin_collect_news.php?action=add'>添加新闻项目</a>",
		14=>"<a target='I2' href='admin_collect_news.php?action=customercls'>新闻分类转换</a>",
		15=>"<a target='I2' href='admin_collect_news.php?action=filters'>新闻信息过滤</a>",
		16=>"<a target='I2' href='admin_collect_news.php?action=tempdatabase'>新闻采集数据库</a>",
		17=>"<a target='I2' href='admin_collect_news.php?action=importrule'>导入新闻规则</a>",
